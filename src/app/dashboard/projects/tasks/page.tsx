...
import { ProjectsTasksTable } from '@/components/projects/projects-tasks-table'

export const metadata = {
  title: 'All Project Tasks',
  description: 'Overview of tasks across all projects',
}

export const dynamic = 'force-dynamic'

export default async function ProjectsTasksOverviewPage() {
  ...
  // Fetch all accessible projects for filter dropdown
