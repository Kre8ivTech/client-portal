...
export function PersonalSecuritySettings({ userEmail }: PersonalSecuritySettingsProps) {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4 pt-4 border-t">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button onClick={handlePasswordChange} disabled={changingPassword || !passwords.new || !passwords.confirm}>
